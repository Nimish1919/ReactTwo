...
const Videos = () => {
  ...
  return (
    <Stack direction={['column', 'row']} h={['fit-content', '100vh']}>
      <VStack w={'full'}>
        <video
          controls
        ...
        <VStack alignItems={'flex-start'} p={'8'} overflowY={'auto'}>
          ...
          <Text>
            This is Video Description. Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Ut nesciunt vero magni cumque nostrum animi sunt
            veritatis eaque mollitia eligendi error consequuntur sapiente,
            ullam, numquam similique qui doloremque reiciendis possimus minima?
            Laudantium porro molestiae quis tempora voluptatum, animi architecto
            cumque beatae natus delectus! Consequatur similique tenetur aliquam
            facilis sunt deserunt.
          </Text>
        </VStack>
      </VStack>
      <VStack
